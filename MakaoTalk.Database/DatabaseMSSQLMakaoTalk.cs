...
namespace MakaoTalk.Database
{
    public class DatabaseMSSQLMakaoTalk : DatabaseMSSQL
    {
        ...
        {
            return $@"Data Source=192.168.245.56;Initial Catalog=MakaoTalk;Persist Security Info=True;User ID=sa;Password={ GetUserPW() };MultipleActiveResultSets=True;Connect Timeout=30;Application Name=Upharm";
        }
